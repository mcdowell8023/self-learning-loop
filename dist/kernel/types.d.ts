export type CandidateScope = 'general' | `tool:${string}` | `role:${string}` | 'skill';
/** §5.2.1 八态状态机 */
export type CandidateState = 'pending' | 'reviewing' | 'validating' | 'conflict' | 'graduated' | 'retired' | 'dormant' | 'rejected';
 ...
 */
export type { SessionEvent, SessionRef, } from './schemas/session.js';
export type { AuditEvent } from './schemas/audit.js';
export type { AssertionStatus, AssertionResult, TrialMetrics, } from './schemas/trial.js';
export type { VerdictName, LayerStatus, LayerResult, EvaluationVerdict, } from './schemas/verdict.js';
