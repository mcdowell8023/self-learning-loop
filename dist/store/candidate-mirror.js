...
export function mirrorFileName(candidate) {
...
// Atomic write
// ---------------------------------------------------------------------------
export function writeMirror(candidatesDir, candidate) {
...
// ---------------------------------------------------------------------------
export function isMirrorCurrent(candidatesDir, candidate) {
    const target = mirrorPath(candidatesDir, candidate);
...
export function repairMirrors(candidatesDir, candidates, opts = {}) {
    const result = { total: candidates.length, written: 0, skipped: 0, details: [] };
